...
Try {
	...
	[string]$appVendor = 'GISInternals'
	[string]$appName = 'GDAL 1.11.4 and MapServer 6.4.3'
	[string]$appVersion = ''
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Copy-File -Path "$dirFiles\*" -Destination "$envSystemDrive\OSGeo" -Recurse
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-File -Path "$envSystemDrive\OSGeo\*" -Recurse
		Remove-Folder -Path "$envSystemDrive\OSGeo"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDqcNq6IuSzjhuw
# 10Z690fMmjd3E4y52+P2H//e/FkbxKCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIDDv
# mVLLSIvLIa8/cvRdNh3iz9r/Nm4eVvvmOq0X+aNlMA0GCSqGSIb3DQEBAQUABIIB
# AF9Ra6LCjfkMD7GXgEtoZKn0CdRopO6rLHhCwS9s27uxDZ4CqqMjHiIW81K7ZavC
# sBES8mv9NhmlsHyr1cuvhgQo0up84JKhpgh7GhqZIZUvCKK0fId/InmrgmzMsKIq
# btrHclStPYuOh251qAsqbfrkP4eZXSPAvqe8UOn6QCosToQj/2//VDDZEnmCeDx3
# zLne2TI43sxoUtvxdLltmyHDrQjaGH19tEH4fQ589skowUnniPYpNGzErTumATnZ
# ONeF86ttqXai54lpdiAxrapn481AzAl4FZATdTqkv/H53XJHvBZ8JbEuFb536ITf
# 5tW4iVr4obI4sNxA92My10GhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwMjA2MTc0MDI2WjAjBgkqhkiG9w0BCQQxFgQU
# ZsYgz+gbjmJPJO5rDEykL8GRIScwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAFkopb7rH4cOO5wrtfN0C+hAt1d3ob8hbH8p0YkQogqAAxkm/496xX3I
# wuS2zQWVR260t/7JY7Vk7/T8+UM/HHYLjpocDbIiM8tHOesmk6PJTcvWbc5dfheA
# mAXPoNE5wtOCNJ5sB0jhOHCtKEnr6tlB7+veHkbK/pQQXIYP9H0JRS0PCRBRJNPh
# mURgFyCHQ57hrVH5TpIE7bBJeVOucGU9MiSGZkmt04JiUA07JxbLj0AWukcOsAR2
# W8GwhuG/Rh/nPrtPHPE4j4z9XdMh6dS5K95QPP1ec/y+JFBkCP++BJxYPfmAOuaJ
# tj3rIraDAADQCSAZwqv4vWjpwYwYNHQ=
